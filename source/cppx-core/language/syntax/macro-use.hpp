...
#   define $use_nsname_in               CPPX_USE_NSNAME_IN              ///< \dollarname{use_nsname_in}
...
#   define $use_nsnames_in              CPPX_USE_NSNAMES_IN             ///< \dollarname{use_nsnames_in}
...
#define CPPX_USE_NSNAME_IN( parent_ns, nested_ns ) \
...
#define CPPX_USE_NSNAMES_IN( parent_ns, ... ) \
