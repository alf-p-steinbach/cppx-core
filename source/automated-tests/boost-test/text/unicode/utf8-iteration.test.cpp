...
#include <cppx-core-language/syntax/declarations.hpp>               // $alias_cppx_ns
#include <cppx-core-language/syntax/types/type-builders.hpp>        // cppx::(P_, Raw_array_of_)
